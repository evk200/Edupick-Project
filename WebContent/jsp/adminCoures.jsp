	...
	<head>
		...
		<script>
			function check(){
				...
				alert("등록합니다.");
				document.cladmain.action="<%=request.getContextPath() %>/Admin2/adminCourseAction.do";
		...
		<section>
			<article>
				<form class="cladmain" name="cladmain">
					<ul id="main1">
						<li>수강명 : <input type="text" name="cname"></li>
						<li>수강비 : <input type="text" name="cprice"></li>
						<li>수강기간 : <input type="text" name="cperiod"> 상시<input type="checkbox"></li>						
						<li>수강시간 : <input type="text" name="ctime"></li>
						<li>모집인원 : <input type="text" name="cpeople"> <input type="checkbox" name="cpeople"> 제한없음</li>
						<li>파일 : <input type="file" name="cfile"></li>
					</ul>
					<ul id="main2">
						<li>강의교재 : <input type="text" name="cbook"></li>
						<li>강의목표 : <input type="text" name="caim"></li>
					</ul>
