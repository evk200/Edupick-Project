...
<!-- title 아이콘 -->
		...
		function check(){
			...
			alert("등록합니다.");
			document.frm.action="<%=request.getContextPath() %>/Admin2/adminPageEduInformationAction.do";
		...
		<article>
			<form class="pagefrmp" name="frm">
				...
				<table style="border-collapse:collapse">
					<tr>
						<td width=10%>제목</td>
						<td width=150%><input name="esubject"></td>
					</tr>
					<tr>
						<td>내용</td>
					...
					<tr>
						<td>작성자</td>
						<td><input name="ewriter"></td>
					</tr>
					<tr>
						<td>첨부파일</td>
						<td><input type="file" name="efile" size="200"></td>
					</tr>
				</table>
